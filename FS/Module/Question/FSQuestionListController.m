...
@interface FSQuestionListController ()

@end

@implementation FSQuestionListController
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"hello"];

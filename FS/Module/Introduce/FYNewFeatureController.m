...
//        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(bannerChangedHandler) name:DISCOVERY_BANNER_CHANGED object:nil];
    }
    return self;
}
...
- (void)start {
    // todo  no use here
//    if ([SAIDiscoveryConfig GetBanner].count > 0) {
    if (1) {
